...
public class Inversion {
    private static int getMajorityElement(int[] a, int left, int right) {
        ...
        int mr = getMajorityElement(a, mid + 1, right);
        return merge(ml, mr, left, right, a);
    }

    private static int merge(int leftCount, int rightCount, int left, int right, int[] a){
    ...
    private static int count(int[] a, int left, int right, int el) {
        int count = 0;
